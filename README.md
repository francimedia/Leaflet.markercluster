...
* **enablePhotoClusterMode**: If set to true, photos are used instead of markers. Add a photo via the option value "photo_url" to L.Marker or "photo_url" as property to a geoJSON String.
